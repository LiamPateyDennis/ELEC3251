...
\subsection{Ideal Calculations}
    ...
    \begin{tikzpicture}[scale=1.4, transform shape]
        ...
        %Primary
        \draw (0,0) to [vsource,v=V,scale=0.8] ++(0,2)
         to (0,2)
...
\begin{figure}[htp]
    ...
    \end{figure}
    \noindent The non-ideal components of the current flyback converter can be 
    modelled like this. This included resistances represent the internal 
\subsection{Ideal Simulations}
\subsection{Non-Ideal Simulations}
\subsection{Results}
\newpage
