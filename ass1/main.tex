...
\begin{figure}[htp]
    ...
    \end{equation}
\subsection{Ideal Simulations}
To simulate an ideal flyback scenario were set, all components were set to 
ideal with no leakage resistances or inductances. This however did not produce the intended result.
\subsection{Non-Ideal Simulations}
\subsection{Results}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Flyback/tek0001.png}
